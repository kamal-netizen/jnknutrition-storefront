...
const STYLES: Record<string, string> = {
  ...
  UNFULFILLED: "bg-[#E2E8F0] text-[#55637A] border-[#E2E8F0]",
  PARTIALLY_FULFILLED: "bg-[#F9D20F]/15 text-[#F9D20F] border-[#F9D20F]/30",
  IN_PROGRESS: "bg-[#F9D20F]/15 text-[#F9D20F] border-[#F9D20F]/30",
  ON_HOLD: "bg-[#E2E8F0] text-[#55637A] border-[#E2E8F0]",
  SCHEDULED: "bg-[#E2E8F0] text-[#55637A] border-[#E2E8F0]",
  RESTOCKED: "bg-[#E2E8F0] text-[#55637A] border-[#E2E8F0]",
  // Financial
  PAID: "bg-[#22C55E]/15 text-[#22C55E] border-[#22C55E]/30",
  PENDING: "bg-[#F9D20F]/15 text-[#F9D20F] border-[#F9D20F]/30",
  REFUNDED: "bg-[#E2E8F0] text-[#55637A] border-[#E2E8F0]",
  PARTIALLY_REFUNDED: "bg-[#E2E8F0] text-[#55637A] border-[#E2E8F0]",
...
export default function OrderStatusBadge({ status }: Props) {
  const style =
    STYLES[status] ?? "bg-[#E2E8F0] text-[#55637A] border-[#E2E8F0]";
  return (
    <span
